...
for params in ParameterGrid(param_grid):
    ...
    train_dataset = dataset_train.map(preprocess_samples_reg, batched=True, remove_columns=dataset_train.column_names)
    ...
    print(params)
    print(results)
    params_reg.append(params)
    results_reg.append(results)

json.dump(results_reg, open("results-reg__seed_{seed}.json".format(removal_strategy=removal_strategy, seed=seed), 'w' ) )
json.dump(params_reg, open("params-reg_removal_{seed}.json".format(removal_strategy=removal_strategy, seed=seed), 'w' ) )
